...
<div class="main-card mb-3 card">
	<div class="card-header">
		<h3 class="mr-3">BGH Eco Smart - Garantías - editar</h3>
	</div>
</div>

<form method="POST" action="{{ url('garantiaonsite/' . $garantiaOnsite->id) }}" id="garantiaonsite" enctype="multipart/form-data" novalidate="novalidate">
	{{ csrf_field() }}
