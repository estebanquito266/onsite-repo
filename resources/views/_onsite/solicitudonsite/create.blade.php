...
<div class="main-card mb-3 card">
	<div class="card-header">
		<h3 class="mr-3">Crear Solicitud</h3>
	</div>
</div>
...
@section('modals')
@include('_onsite.solicitudonsite.modalConfirmacion') 
...
<script type="text/javascript" src="{!! asset('/assets/js/solicitudes/postQuerys.js') !!}"></script>
<script type="text/javascript" src="{!! asset('/assets/js/solicitudes/functions.js') !!}"></script>
