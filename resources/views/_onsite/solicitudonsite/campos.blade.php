				...
				<div id="step-2" class="tab-pane step-content" style="display: block;">
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="tableBouchers" class="table table-striped table-bordered table_bouchers" cellspacing="0" width="100%">
							</table>
						</div>
					</div>

					<div id="div_sin_boucher" class="col-12">

					</div>

					<div class="card-body">
						<div class="table-responsive">
							<table id="tableSinBouchers" class="table table-striped table-bordered table_sin_bouchers" cellspacing="0" width="100%">
							</table>
						</div>
					</div>
				</div>
