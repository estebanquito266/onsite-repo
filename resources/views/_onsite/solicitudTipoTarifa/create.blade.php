...
@section('content')
	...
	<div class="main-card mb-3 card">
		<div class="card-header">
			<h3 class="mr-3">Agregar Tarifas por OBRA </h3>
		</div>
	</div>

	<form method="POST" action="{{ url('solicitudesTiposTarifas') }}" id="solicitudesTiposTarifasForm" >
		{{ csrf_field() }}

		@include('_onsite.solicitudTipoTarifa.campos')
