...
use App\Mail\ServiciosExtrasMail;
use App\Services\MailService;

class ServiciosExtrasNotification extends Notification
{
    use Queueable;
    ...
    {  
        // $data_mail = $this->mailService->enviarMailServiciosExtrasSend($this->array_data);
        $mailable = new ServiciosExtrasMail($this->mailService,$this->array_data);
        Log::info('Servicios Extras Notification: ARRAY: ' . $this->lineaClaseLogs . __LINE__  );
