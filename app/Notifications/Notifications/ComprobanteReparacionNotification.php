...
use App\Mail\ComprobanteReparacionMail;
use App\Mail\SendMail;
use App\Services\MailService;

class ComprobanteReparacionNotification extends Notification
{
    use Queueable;
    ...
    {  
        // $data_mail = $this->mailService->enviarMailComprobanteSend($this->array_data);
        $mailable = new ComprobanteReparacionMail($this->mailService,$this->array_data);
        Log::info('Comprobante Reparacón Notification: ARRAY: ' . $this->lineaClaseLogs . __LINE__  );
