...
use App\Mail\OrdenElockerMail;
use App\Mail\SendMail;
use App\Services\MailService;

class OrdenElockerSend extends Notification
{
    use Queueable;
    ...
    {  
        // $data_mail = $this->mailService->enviarMailOrdenElockerSend($this->array_data);
        $mailable = new OrdenElockerMail($this->mailService,$this->array_data);
        Log::info('Orden Oca Notification: ARRAY: ' . $this->lineaClaseLogs . __LINE__  );
