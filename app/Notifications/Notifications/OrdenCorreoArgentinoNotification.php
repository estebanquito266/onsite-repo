...
use App\Mail\OrdenCorreoArgentinoMail;
use App\Mail\SendMail;
use App\Services\MailService;

class OrdenCorreoArgentinoNotification extends Notification
{
    use Queueable;
    ...
    {  
        // $data_mail = $this->mailService->enviarMailOrdenCorreoArgentinoSend($this->array_data);
        $mailable = new OrdenCorreoArgentinoMail($this->mailService,$this->array_data);
        Log::info('Orden correo Notification: ARRAY: ' . $this->lineaClaseLogs . __LINE__  );
